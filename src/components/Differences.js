...
export default function Differences() {
  ...
  return (
    <Container>
      <Box>
        <Typography variant="h4" gutterBottom>Welcome to FoxFiles!</Typography>
        <Typography variant="p" component="p" className={classes.longDescription} gutterBottom>
        ...
        <Typography variant="p" component="p" className={classes.longDescription}>
